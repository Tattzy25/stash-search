...
function generateMarketingDescription(text: string): string {
  ...
  const isTattoo = text.toLowerCase().includes('tattoo') ||
  ...
  if (text.toLowerCase().includes('black and white') || text.toLowerCase().includes('monochrome')) {
    description += "A striking black and white tattoo design ";
  } else if (text.toLowerCase().includes('color') || text.toLowerCase().includes('colored')) {
  ...
  if (text.toLowerCase().includes('small') || text.toLowerCase().includes('minimal')) {
    description += "perfect for small placements. ";
  } else if (text.toLowerCase().includes('large') || text.toLowerCase().includes('bold')) {
  ...
  // Meaning/symbolism
  if (text.toLowerCase().includes('strength') || text.toLowerCase().includes('power')) {
    description += "Symbolizing strength and resilience, this design captures the essence of inner power. ";
  } else if (text.toLowerCase().includes('love') || text.toLowerCase().includes('heart')) {
    description += "Expressing deep emotion and connection, this piece represents love in its purest form. ";
  } else if (text.toLowerCase().includes('freedom') || text.toLowerCase().includes('spirit')) {
    description += "Embodying freedom and spirituality, this tattoo speaks to the wandering soul. ";
  } else {
    description += "Carrying deep personal meaning, this design tells your unique story. ";
  }

  // Non-salesy CTA
  description += "Consider bringing this vision to life as part of your personal art collection.";
